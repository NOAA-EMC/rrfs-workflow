...
#-----------------------------------------------------------------------
#
EXPT_BASEDIR="${HOMErrfs}/parm/config"
EXPT_SUBDIR="enkf"
#
#-----------------------------------------------------------------------
#
...
TAG="n3enkf91"
WGF="enkf"
PTMP="/lfs/h3/emc/lam/noscrub/ecflow/ptmp/emc.lam/ecflow_rrfs/para/com/rrfs/v1.0"
ENSCTRL_PTMP="/lfs/h3/emc/lam/noscrub/ecflow/ptmp/emc.lam/ecflow_rrfs/para/com/rrfs/v1.0"
GESROOT="/lfs/h3/emc/lam/noscrub/ecflow/ptmp/emc.lam/ecflow_rrfs/para/nwges"
ENSCTRL_GESROOT="/lfs/h3/emc/lam/noscrub/ecflow/ptmp/emc.lam/ecflow_rrfs/para/nwges"
RRFSE_GESROOT="/base/path/of/directory/containing/model/output/files"
...
#-----------------------------------------------------------------------
#
DATE_FIRST_CYCL="20241029"
DATE_LAST_CYCL="20241031"
STARTYEAR="2024"
STARTMONTH="10"
STARTDAY="29"
STARTHOUR="00"
...
INITIAL_CYCLEDEF="202410290700 202410312300 12:00:00"
BOUNDARY_CYCLEDEF="202410290000 202410312300 06:00:00"
BOUNDARY_LONG_CYCLEDEF="00 01 01 01 2100 *"
SPINUP_CYCLEDEF="202410290700 202410312300 12:00:00"
PROD_CYCLEDEF="00 01-05,08-11,13-17,20-23 29-31 10 2024 *"
RECENTER_CYCLEDEF="00 01 01 01 2100 *"
PRODLONG_CYCLEDEF="202410290000 202410312300 06:00:00"
SAVEDA_CYCLEDEF="202410290000 202410312300 06:00:00"
#
#-----------------------------------------------------------------------
#
...
NNODES_MAKE_LBCS="1"
NNODES_PREP_CYC="1"
NNODES_FORECAST="13"  # This is calculated in the workflow generation scripts, so no need to set here.
NNODES_POST="4"
NNODES_PRDGEN="1"
...
PPN_MAKE_LBCS="64"
PPN_PREP_CYC="1"
PPN_FORECAST="64"  # This may have to be changed depending on the number of threads used.
PPN_POST="32"
PPN_PRDGEN="128"
PPN_ANALYSIS_GSI="16"
...
ENSMEM_NAMES=( "mem001" "mem002" "mem003" "mem004" "mem005" "mem006" "mem007" "mem008" "mem009" "mem010" "mem011" "mem012" "mem013" "mem014" "mem015" "mem016" "mem017" "mem018" "mem019" "mem020" "mem021" "mem022" "mem023" "mem024" "mem025" "mem026" "mem027" "mem028" "mem029" "mem030" )
FV3_NML_ENSMEM_FPS=( "$HOMErrfs/parm/config/enkf/input.nml_mem001" "$HOMErrfs/parm/config/enkf/input.nml_mem002" "$HOMErrfs/parm/config/enkf/input.nml_mem003" "$HOMErrfs/parm/config/enkf/input.nml_mem004" "$HOMErrfs/parm/config/enkf/input.nml_mem005" "$HOMErrfs/parm/config/enkf/input.nml_mem006" "$HOMErrfs/parm/config/enkf/input.nml_mem007" "$HOMErrfs/parm/config/enkf/input.nml_mem008" "$HOMErrfs/parm/config/enkf/input.nml_mem009" "$HOMErrfs/parm/config/enkf/input.nml_mem010" "$HOMErrfs/parm/config/enkf/input.nml_mem011" "$HOMErrfs/parm/config/enkf/input.nml_mem012" "$HOMErrfs/parm/config/enkf/input.nml_mem013" "$HOMErrfs/parm/config/enkf/input.nml_mem014" "$HOMErrfs/parm/config/enkf/input.nml_mem015" "$HOMErrfs/parm/config/enkf/input.nml_mem016" "$HOMErrfs/parm/config/enkf/input.nml_mem017" "$HOMErrfs/parm/config/enkf/input.nml_mem018" "$HOMErrfs/parm/config/enkf/input.nml_mem019" "$HOMErrfs/parm/config/enkf/input.nml_mem020" "$HOMErrfs/parm/config/enkf/input.nml_mem021" "$HOMErrfs/parm/config/enkf/input.nml_mem022" "$HOMErrfs/parm/config/enkf/input.nml_mem023" "$HOMErrfs/parm/config/enkf/input.nml_mem024" "$HOMErrfs/parm/config/enkf/input.nml_mem025" "$HOMErrfs/parm/config/enkf/input.nml_mem026" "$HOMErrfs/parm/config/enkf/input.nml_mem027" "$HOMErrfs/parm/config/enkf/input.nml_mem028" "$HOMErrfs/parm/config/enkf/input.nml_mem029" "$HOMErrfs/parm/config/enkf/input.nml_mem030" )
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="$HOMErrfs/parm/config/enkf/var_defns.sh"
...
DIAG_TABLE_TMPL_FN="diag_table.RRFS_sas_clm"
FIELD_TABLE_TMPL_FN="field_table.RRFS_sas"
MODEL_CONFIG_TMPL_FN="model_configure"
UFS_CONFIG_TMPL_FN="ufs.configure"

DATA_TABLE_TMPL_FP="$HOMErrfs/parm/data_table"
DIAG_TABLE_TMPL_FP="$HOMErrfs/parm/diag_table.RRFS_sas_clm"
FIELD_TABLE_TMPL_FP="$HOMErrfs/parm/field_table.RRFS_sas"
...
CCPP_PHYS_SUITE_FN="suite_RRFS_sas.xml"
CCPP_PHYS_SUITE_IN_CCPP_FP="$HOMErrfs/sorc/ufs-weather-model/FV3/ccpp/suites/suite_RRFS_sas.xml"
CCPP_PHYS_SUITE_FP="$HOMErrfs/parm/config/enkf/suite_RRFS_sas.xml"

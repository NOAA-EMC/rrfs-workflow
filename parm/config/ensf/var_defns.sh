...
PROD_CYCLEDEF="202410290000 202410312300 06:00:00"
RECENTER_CYCLEDEF="202410290000 202410312300 06:00:00"
...
NNODES_MAKE_LBCS="1"
NNODES_PREP_CYC="1"
NNODES_FORECAST="52"  # This is calculated in the workflow generation scripts, so no need to set here.
NNODES_POST="4"
NNODES_PRDGEN="1"
...
ENSMEM_NAMES=( "mem001" "mem002" "mem003" "mem004" "mem005" )
FV3_NML_ENSMEM_FPS=( "$HOMErrfs/parm/config/ensf/input.nml_mem001" "$HOMErrfs/parm/config/ensf/input.nml_mem002" "$HOMErrfs/parm/config/ensf/input.nml_mem003" "$HOMErrfs/parm/config/ensf/input.nml_mem004" "$HOMErrfs/parm/config/ensf/input.nml_mem005" )
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="$HOMErrfs/parm/config/ensf/var_defns.sh"
...
CCPP_PHYS_SUITE_FP="$HOMErrfs/parm/config/ensf/suite_RRFS_sas.xml"

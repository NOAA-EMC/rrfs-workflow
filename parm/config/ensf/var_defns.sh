...
BOUNDARY_CYCLEDEF="202405310000 202405312300 06:00:00"
BOUNDARY_LONG_CYCLEDEF="00 01 01 01 2100 *"
SPINUP_CYCLEDEF="00 01 01 01 2100 *"
PROD_CYCLEDEF="202405310000 202405312300 06:00:00"
RECENTER_CYCLEDEF="202405310000 202405312300 06:00:00"
PRODLONG_CYCLEDEF="00 01 01 01 2100 *"
ARCHIVE_CYCLEDEF="00 01 01 01 2100 *"
SAVEDA_CYCLEDEF="202405310000 202405312300 06:00:00"
#
#-----------------------------------------------------------------------
#
...
NNODES_RUN_FCST="52"  # This is calculated in the workflow generation scripts, so no need to set here.
NNODES_RUN_POST="4"
NNODES_RUN_PRDGEN="1"
...
#
DO_LSM_SPP="TRUE" #If true, sets lndp_type=2
LSM_SPP_TSCALE=( \
"21600" \
"21600" \
"21600" \
...
WFLOW_LAUNCH_LOG_FP="$HOMErrfs/parm/config/ensf/log.launch_FV3LAM_wflow"
CRONTAB_LINE=""
#
#-----------------------------------------------------------------------
#
...
FIXam="$HOMErrfs/parm/config/ensf/fix_am"
FIXLAM="$HOMErrfs/parm/config/ensf/fix_lam"
FIXgsm="$HOMErrfs/fix/am"
FIXprdgen="$HOMErrfs/fix/prdgen"
...
EXPTDIR="$HOMErrfs/parm/config/ensf"
...
ENSMEM_NAMES=( "mem0001" "mem0002" "mem0003" "mem0004" "mem0005" )
FV3_NML_ENSMEM_FPS=( "/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v0.9.5/rrfs_na_enfcst/input.nml_mem0001" "/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v0.9.5/rrfs_na_enfcst/input.nml_mem0002" "/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v0.9.5/rrfs_na_enfcst/input.nml_mem0003" "/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v0.9.5/rrfs_na_enfcst/input.nml_mem0004" "/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v0.9.5/rrfs_na_enfcst/input.nml_mem0005" )
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/para/packages/rrfs.v1.0.0/parm/config/ensf/var_defns.sh"
...
FV3_NML_BASE_ENS_FP="$HOMErrfs/parm/config/ensf/input.nml.base_ens"
...
CCPP_PHYS_SUITE_FP="$HOMErrfs/parm/config/ensf/suite_FV3_HRRR_gf.xml"

DATA_TABLE_FP="$HOMErrfs/parm/config/ensf/data_table"
FIELD_TABLE_FP="$HOMErrfs/parm/config/ensf/field_table"
...
UFS_CONFIG_FP="$HOMErrfs/parm/config/ensf/ufs.configure"
...
THOMPSON_MP_CLIMO_FP="$HOMErrfs/parm/config/ensf/fix_am/Thompson_MP_MONTHLY_CLIMO.nc"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
LBC_SPEC_FCST_HRS=(0 3 6 9 12 15 18 21 24 27 30 33 36 39 42 45 48 51 54 57 60)

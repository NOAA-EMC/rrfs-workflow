...
TAG="n3v91"
WGF="firewx"
PTMP="/lfs/h2/emc/ptmp/emc.lam/rrfs/v0.9.1"
...
PROD_CYCLEDEF="202410290000 202410311800 06:00:00"
...
AIRCRAFT_REJECT="$HOMErrfs/fix"
SFCOBS_USELIST="$HOMErrfs/fix"
#
#-----------------------------------------------------------------------
#
...
EXTRN_MDL_SOURCE_BASEDIR_ICS="${COMrrfs}"
EXTRN_MDL_FILES_ICS=( \
"ICS_file1" \
"ICS_file2" \
"..." \
)
EXTRN_MDL_SOURCE_BASEDIR_LBCS="${COMrrfs}"
EXTRN_MDL_FILES_LBCS=( \
"LBCS_file1" \
"LBCS_file2" \
"..." \
...
#-----------------------------------------------------------------------
#
CCPP_PHYS_SUITE="RRFS_sas_nogwd"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
ESGgrid_LON_CTR="-123.0"
ESGgrid_LAT_CTR="49.3"
...
GRID_DIR="$HOMErrfs/parm/config/firewx/grid"

RUN_TASK_MAKE_OROG="TRUE"
OROG_DIR="$HOMErrfs/parm/config/firewx/orog"

RUN_TASK_MAKE_SFC_CLIMO="TRUE"
SFC_CLIMO_DIR="$HOMErrfs/parm/config/firewx/sfc_climo"
...
NNODES_MAKE_LBCS="1"
NNODES_PREP_CYC="1"
NNODES_FORECAST="4"  # This is calculated in the workflow generation scripts, so no need to set here.
NNODES_POST="2"
NNODES_PRDGEN="1"
...
PPN_MAKE_LBCS="36"
PPN_PREP_CYC="1"
PPN_FORECAST="63"  # This may have to be changed depending on the number of threads used.
PPN_POST="24"
PPN_PRDGEN="1"
PPN_ANALYSIS_GSI="24"
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="$HOMErrfs/parm/config/firewx/var_defns.sh"
...
DIAG_TABLE_TMPL_FN="diag_table.RRFS_sas_nogwd"
FIELD_TABLE_TMPL_FN="field_table.RRFS_sas_nogwd"
MODEL_CONFIG_TMPL_FN="model_configure"
UFS_CONFIG_TMPL_FN="ufs.configure"

DATA_TABLE_TMPL_FP="$HOMErrfs/parm/data_table"
DIAG_TABLE_TMPL_FP="$HOMErrfs/parm/diag_table.RRFS_sas_nogwd"
FIELD_TABLE_TMPL_FP="$HOMErrfs/parm/field_table.RRFS_sas_nogwd"
FV3_NML_BASE_SUITE_FP="$HOMErrfs/parm/input.nml.RRFSFW"
FV3_NML_YAML_CONFIG_FP="$HOMErrfs/parm/"
...
CCPP_PHYS_SUITE_FN="suite_RRFS_sas_nogwd.xml"
CCPP_PHYS_SUITE_IN_CCPP_FP="$HOMErrfs/sorc/ufs-weather-model/FV3/ccpp/suites/suite_RRFS_sas_nogwd.xml"
CCPP_PHYS_SUITE_FP="$HOMErrfs/parm/config/firewx/suite_RRFS_sas_nogwd.xml"
...
#-----------------------------------------------------------------------
#
EXTRN_MDL_SYSBASEDIR_ICS="${COMrrfs}"
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
EXTRN_MDL_SYSBASEDIR_LBCS="${COMrrfs}"
#
#-----------------------------------------------------------------------
#
# Shift back in time (in units of hours) of the starting time of the ex-

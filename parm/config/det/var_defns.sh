...
INITIAL_CYCLEDEF="202405300300 202405312300 12:00:00"
BOUNDARY_CYCLEDEF="202405300000 202405312300 06:00:00"
BOUNDARY_LONG_CYCLEDEF="00 01 01 01 2100 *"
SPINUP_CYCLEDEF="00 03-08,15-20 30-31 05 2024 *"
PROD_CYCLEDEF="00 01-05,07-11,13-17,19-23 30-31 05 2024 *"
RECENTER_CYCLEDEF="00 01 01 01 2100 *"
PRODLONG_CYCLEDEF="00 00,06,12,18 30-31 05 2024 *"
ARCHIVE_CYCLEDEF="202405301400 202405312300 24:00:00"
...
#-----------------------------------------------------------------------
#
CLEAN_OLDPROD_HRS="24"
CLEAN_OLDLOG_HRS="24"
CLEAN_OLDRUN_HRS="7"
CLEAN_OLDFCST_HRS="7"
CLEAN_OLDSTMPPOST_HRS="7"
CLEAN_NWGES_HRS="7"
...
WFLOW_LAUNCH_LOG_FP="$HOMErrfs/parm/config/det/log.launch_FV3LAM_wflow"
CRONTAB_LINE=""
#
#-----------------------------------------------------------------------
#
...
FIXam="$HOMErrfs/parm/config/det/fix_am"
FIXLAM="$HOMErrfs/parm/config/det/fix_lam"
FIXgsm="$HOMErrfs/fix/am"
FIXprdgen="$HOMErrfs/fix/prdgen"
...
EXPTDIR="$HOMErrfs/parm/config/det"
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/para/packages/rrfs.v1.0.0/parm/config/det/var_defns.sh"
...
FV3_NML_BASE_ENS_FP="$HOMErrfs/parm/config/det/input.nml.base_ens"
...
CCPP_PHYS_SUITE_FP="$HOMErrfs/parm/config/det/suite_FV3_HRRR_gf.xml"

DATA_TABLE_FP="$HOMErrfs/parm/config/det/data_table"
FIELD_TABLE_FP="$HOMErrfs/parm/config/det/field_table"
...
UFS_CONFIG_FP="$HOMErrfs/parm/config/det/ufs.configure"
...
THOMPSON_MP_CLIMO_FP="$HOMErrfs/parm/config/det/fix_am/Thompson_MP_MONTHLY_CLIMO.nc"
#
#-----------------------------------------------------------------------
#

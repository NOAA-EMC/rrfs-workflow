...
! THE SURFACE PRESSURE IS NO LONGER CONSISTENT WITH DELTA P.
 ...
 SUBROUTINE READ_GRBGFS_ATMS_DATA_NEMSIO(GFILEI, GFSDATAI, GFSHEADI, &
                                         VCOORD, LEVSP1, NVCOORD)
 ...
 print*,''
 print*,'READ GRBGFS ATMOSPHERIC NEMSIO FILE'
 ...
 DEALLOCATE(TMP)
	...
	PRINT *, 'IN READ_GRBGFS_ATMS_DATA_NEMSIO'
	PRINT *, 'MIN,MAX TI(1) = ', MINVAL(GFSDATAI%T(:,:,1)), MAXVAL(GFSDATAI%T(:,:,1))
	PRINT *, 'MIN,MAX QI(1) = ', MINVAL(GFSDATAI%Q(:,:,1,1)), MAXVAL(GFSDATAI%Q(:,:,1,1))
	PRINT *, 'MIN,MAX UI(1) = ', MINVAL(GFSDATAI%U(:,:,1)), MAXVAL(GFSDATAI%U(:,:,1))
	PRINT *, 'MIN,MAX VI(1) = ', MINVAL(GFSDATAI%V(:,:,1)), MAXVAL(GFSDATAI%V(:,:,1))
	PRINT *, 'MIN,MAX PSI = ', MINVAL(GFSDATAI%PS(:,:)), MAXVAL(GFSDATAI%PS(:,:))
 ...
 END SUBROUTINE READ_GRBGFS_ATMS_DATA_NEMSIO
 
 SUBROUTINE READ_GRBRAP_ATMS_DATA_NEMSIO(GFILEI, GFSDATAI, GFSHEADI, &
                                         VCOORD, LEVSP1, NVCOORD)
 ...
 print*,''
 print*,'READ GRBRAP ATMOSPHERIC NEMSIO FILE'
 ...
 PRINT*,'READ ICMR'
 DO L = 1, LEVSI
   CALL NEMSIO_READRECV(GFILEI, 'cicemr', 'mid layer', L, TMP, IRET=IRET)
   IF (IRET /= 0) GOTO 99
   GFSDATAI%Q(:,:,L,5) = RESHAPE(TMP,(/LONB,LATB/))
 ENDDO
 ...
 PRINT*,'READ GRLE'
 DO L = 1, LEVSI
   CALL NEMSIO_READRECV(GFILEI, 'grplemr', 'mid layer', L, TMP, IRET=IRET)
   IF (IRET /= 0) GOTO 99
   GFSDATAI%Q(:,:,L,7) = RESHAPE(TMP,(/LONB,LATB/))
 ENDDO
 ...
 DEALLOCATE(TMP)
	...
	PRINT *, 'IN READ_GRBGFS_ATMS_DATA_NEMSIO'
	PRINT *, 'MIN,MAX TI(26) = ', MINVAL(GFSDATAI%T(:,:,26)), MAXVAL(GFSDATAI%T(:,:,26))
	PRINT *, 'MIN,MAX QI(26) = ', MINVAL(GFSDATAI%Q(:,:,26,1)), MAXVAL(GFSDATAI%Q(:,:,26,1))
	PRINT *, 'MIN,MAX UI(26) = ', MINVAL(GFSDATAI%U(:,:,26)), MAXVAL(GFSDATAI%U(:,:,26))
	PRINT *, 'MIN,MAX VI(26) = ', MINVAL(GFSDATAI%V(:,:,26)), MAXVAL(GFSDATAI%V(:,:,26))
	PRINT *, 'MIN,MAX PSI(26) = ', MINVAL(GFSDATAI%PS(:,:)), MAXVAL(GFSDATAI%PS(:,:))
 ...
 END SUBROUTINE READ_GRBRAP_ATMS_DATA_NEMSIO
 ...
 subroutine write_fv3_sfc_data_netcdf(lonb, latb, lsoil, sfcoutput, f10m, &
                           ...
                           num_nsst_fields, write_nsst, nsst_output)
...
!--- define dimension
 ...
 call netcdf_err(error, 'WRITING SRFLAG RECORD' )
  ...
  print *, 'in writing sfc data'
  print *, 'max output snow depth = ',maxval(sfcoutput%snow_depth)
 ...
 subroutine write_grbgfs_sfc_data_netcdf(lonb, latb, lsoil, sfcoutput, &
                           t2m, q2m, srflag, tile, &
...
!--- define dimension
 ...
 end subroutine write_grbgfs_sfc_data_netcdf
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_PS_BOTTOM, "units", "Pa")
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_PS_TOP, "units", "Pa")
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_PS_RIGHT, "units", "Pa")
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_PS_LEFT, "units", "Pa")
 CALL NETCDF_ERR(ERROR, 'DEFINING PS_LEFT UNITS')
 ...
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_BOTTOM ATTRIBUTE')
 IF (TRIM(MODELNAME) == "FV3GFS") THEN
   ERROR = NF90_PUT_ATT(NCID2, ID_W_BOTTOM, "units", "m/s")
 ELSE
   ERROR = NF90_PUT_ATT(NCID2, ID_W_BOTTOM, "units", "Pa/s")
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_BOTTOM UNITS')
 ...
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_TOP ATTRIBUTE')
 IF (TRIM(MODELNAME) == "FV3GFS") THEN
   ERROR = NF90_PUT_ATT(NCID2, ID_W_TOP, "units", "m/s")
 ELSE
   ERROR = NF90_PUT_ATT(NCID2, ID_W_TOP, "units", "Pa/s")
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_TOP UNITS')
 ...
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_RIGHT ATTRIBUTE')
 IF (TRIM(MODELNAME) == "FV3GFS") THEN
   ERROR = NF90_PUT_ATT(NCID2, ID_W_RIGHT, "units", "m/s")
 ELSE
   ERROR = NF90_PUT_ATT(NCID2, ID_W_RIGHT, "units", "Pa/s")
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_RIGHT UNITS')
 ...
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_LEFT ATTRIBUTE')
 IF (TRIM(MODELNAME) == "FV3GFS") THEN
   ERROR = NF90_PUT_ATT(NCID2, ID_W_LEFT, "units", "m/s")
 ELSE
   ERROR = NF90_PUT_ATT(NCID2, ID_W_LEFT, "units", "Pa/s")
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_ZH_BOTTOM, "units", "m")
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_ZH_TOP, "units", "m")
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_ZH_RIGHT, "units", "m")
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_ZH_LEFT, "units", "m")
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING T_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_T_BOTTOM, "units", "kelvin")
 CALL NETCDF_ERR(ERROR, 'DEFINING T_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING T_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_T_TOP, "units", "kelvin")
 CALL NETCDF_ERR(ERROR, 'DEFINING T_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING T_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_T_RIGHT, "units", "kelvin")
 CALL NETCDF_ERR(ERROR, 'DEFINING T_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING T_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_T_LEFT, "units", "kelvin")
 CALL NETCDF_ERR(ERROR, 'DEFINING T_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_SPHUM_BOTTOM, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_SPHUM_TOP, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_SPHUM_RIGHT, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_SPHUM_LEFT, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_O3MR_BOTTOM, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_O3MR_TOP, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_O3MR_RIGHT, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_O3MR_LEFT, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_CLWMR_BOTTOM, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_CLWMR_TOP, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR_TOP UNITS')
 ...
 IF (NTRACM > 3) THEN
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_BOTTOM ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_RWMR_BOTTOM, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_BOTTOM UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_TOP ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_RWMR_TOP, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_TOP UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_RIGHT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_RWMR_RIGHT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_RIGHT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_LEFT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_RWMR_LEFT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR_LEFT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_BOTTOM ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_ICMR_BOTTOM, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_BOTTOM UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_TOP ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_ICMR_TOP, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_TOP UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_RIGHT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_ICMR_RIGHT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_RIGHT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_LEFT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_ICMR_LEFT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR_LEFT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_BOTTOM ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_SNMR_BOTTOM, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_BOTTOM UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_TOP ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_SNMR_TOP, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_TOP UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_RIGHT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_SNMR_RIGHT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_RIGHT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_LEFT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_SNMR_LEFT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR_LEFT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_BOTTOM ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_GRLE_BOTTOM, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_BOTTOM UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_TOP ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_GRLE_TOP, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_TOP UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_RIGHT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_GRLE_RIGHT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_RIGHT UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_LEFT ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_GRLE_LEFT, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_W_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_W_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_W_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_W_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_W_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_W_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_W_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_W_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_W_BOTTOM, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_W_TOP, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_W_RIGHT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_W_LEFT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_W_BOTTOM, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_W_TOP, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_W_RIGHT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_W_LEFT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_S_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_S_BOTTOM ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_S_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_S_TOP ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_S_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_S_RIGHT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING I_S_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING J_S_LEFT ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_S_BOTTOM, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_S_TOP, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_S_RIGHT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_S_LEFT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S_LEFT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_BOTTOM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_S_BOTTOM, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_BOTTOM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_TOP ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_S_TOP, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_TOP UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_RIGHT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_S_RIGHT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_RIGHT UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_LEFT ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_S_LEFT, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S_LEFT UNITS')
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'WRITING T_BOTTOM')
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'WRITING T_TOP')
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'WRITING T_LEFT')
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'WRITING T_RIGHT')
...
!----------------------------------------------------------------------------------
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING PRESSURE ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_PS, "units", "Pa")
 CALL NETCDF_ERR(ERROR, 'DEFINING PRESSURE UNITS')
 ...
 ENDIF
 CALL NETCDF_ERR(ERROR, 'DEFINING W ATTRIBUTE')
 IF (TRIM(MODELNAME) == "FV3GFS") THEN
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_ZH, "units", "m")
 CALL NETCDF_ERR(ERROR, 'DEFINING ZH UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING T ATTRIBUTE')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_SPHUM, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING SPHUM UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_O3MR, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING O3MR UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_CLWMR, "units", "kg/kg")
 CALL NETCDF_ERR(ERROR, 'DEFINING CLWMR UNITS')
 ...
 IF (NTRACM > 3) THEN
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_RWMR, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING RWMR UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_ICMR, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING ICMR UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_SNMR, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING SNMR UNITS')
   ...
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE ATTRIBUTE')
   ERROR = NF90_PUT_ATT(NCID2, ID_GRLE, "units", "kg/kg")
   CALL NETCDF_ERR(ERROR, 'DEFINING GRLE UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_W, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_W UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_W, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_W UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_U_S, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING U_S UNITS')
 ...
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S ATTRIBUTE')
 ERROR = NF90_PUT_ATT(NCID2, ID_V_S, "units", "m/s")
 CALL NETCDF_ERR(ERROR, 'DEFINING V_S UNITS')
...
!------------------------------------------------------------------
 ...
 print *, 'MIN MAX T BEFORE WRITE =', MINVAL(T), MAXVAL(T)
 ...
 print *, 'MIN MAX SPHUM BEFORE WRITE =', MINVAL(Q(:,:,:,1)), MAXVAL(Q(:,:,:,1))
 ...
 print *, 'MIN MAX O3MR BEFORE WRITE =', MINVAL(Q(:,:,:,2)), MAXVAL(Q(:,:,:,2))
 ...
 END SUBROUTINE WRITE_FV3_ATMS_NETCDF
  ...
  SUBROUTINE WRITE_FV3_ATMS_BNDY_NETCDF_GRBSRC(ZS,PS,T,W,U,V,Q,VCOORD,LONB,LATB,&
                                  LEVSO,NTRACM,NVCOORD,HALO,INPTYP, &
                                  MODELNAME,KGDSI)
...
!----------------------------------------------------------------------------------
 ...
 CALL EC2ANY(0, 1, PS, LONB, LATB, HALO_2D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 HALO_2D_4BYTE = REAL(HALO_2D,4)
 ...
 CALL EC2ANY(0, LEVSO, Q(:,:,:,1), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO
   HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0, LEVSO, Q(:,:,:,2), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO
   HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0, LEVSO, Q(:,:,:,3), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO
   HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 IF (NTRACM > 3) THEN
   ...
   CALL EC2ANY(0, LEVSO, Q(:,:,:,4), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
   DO K = 1, LEVSO
     HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0, LEVSO, Q(:,:,:,5), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
   DO K = 1, LEVSO
     HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0, LEVSO, Q(:,:,:,6), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
   DO K = 1, LEVSO
     HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0, LEVSO, Q(:,:,:,7), LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
   DO K = 1, LEVSO
     HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
   ENDDO
 ...
 CALL EC2ANY(0, LEVSO, T, LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO
   HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0, LEVSO, W, LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO
   HALO_3D_4BYTE(:,:,LEVSO-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0, LEVSO_P1, ZH, LONB, LATB, HALO_3D, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
 DO K = 1, LEVSO_P1
   HALO_3D_4BYTE(:,:,LEVSO_P1-K+1) = REAL(HALO_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANYV(0, LEVSO, U, V, LONB, LATB, HALO_3D, HALO_3D2, IHALO, JHALO, GEOLON_HALO, GEOLAT_HALO,KGDSI)
...
!----------------------------------------------------------------------------------
 ...
 END SUBROUTINE WRITE_FV3_ATMS_BNDY_NETCDF_GRBSRC

 SUBROUTINE WRITE_FV3_ATMS_NETCDF_GRBSRC(ZS,PS,T,W,U,V,Q,VCOORD,LONB,LATB,&
                                  LEVSO,NTRACM,NVCOORD,NTILES,HALO,&
                                  INPTYP,MODELNAME,KGDSI)
...
!------------------------------------------------------------------
 ...
 CALL EC2ANY(0,1,PS,LONB,LATB,CUBE_2D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 CUBE_2D_4BYTE = REAL(CUBE_2D,4)
 ...
 CALL EC2ANY(0,LEVSO_P1,ZH,LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 DO K = 1, LEVSO_P1
   CUBE_3D_4BYTE(:,:,LEVSO_P1-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0,LEVSO,W,LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 DO K = 1, LEVSO
   CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 print *, 'MIN MAX T BEFORE WRITE =', MINVAL(T), MAXVAL(T)
 CALL EC2ANY(0,LEVSO,T,LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON,GEOLAT,KGDSI)
 DO K = 1, LEVSO
   CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 print *, 'MIN MAX SPHUM BEFORE WRITE =', MINVAL(Q(:,:,:,1)), MAXVAL(Q(:,:,:,1))
 CALL EC2ANY(0,LEVSO,Q(:,:,:,1),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 DO K = 1, LEVSO
   CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 print *, 'MIN MAX O3MR BEFORE WRITE =', MINVAL(Q(:,:,:,2)), MAXVAL(Q(:,:,:,2))
 CALL EC2ANY(0,LEVSO,Q(:,:,:,2),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 DO K = 1, LEVSO
   CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 CALL EC2ANY(0,LEVSO,Q(:,:,:,3),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
 DO K = 1, LEVSO
   CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
 ENDDO
 ...
 IF (NTRACM > 3) THEN
   ...
   CALL EC2ANY(0,LEVSO,Q(:,:,:,4),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
   DO K = 1, LEVSO
     CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0,LEVSO,Q(:,:,:,5),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
   DO K = 1, LEVSO
     CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0,LEVSO,Q(:,:,:,6),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
   DO K = 1, LEVSO
     CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
   ENDDO
   ...
   CALL EC2ANY(0,LEVSO,Q(:,:,:,7),LONB,LATB,CUBE_3D,IM_OUT,JM_OUT,GEOLON, GEOLAT,KGDSI)
   DO K = 1, LEVSO
     CUBE_3D_4BYTE(:,:,LEVSO-K+1) = REAL(CUBE_3D(:,:,K),4)
   ENDDO
 ...
 CALL EC2ANYV(0,LEVSO,U,V,LONB,LATB,CUBE_3D,CUBE_3D2,(IM_OUT+1),JM_OUT,GEOLON_W, GEOLAT_W,KGDSI)
 ...
 CALL EC2ANYV(0,LEVSO,U,V,LONB,LATB,CUBE_3D,CUBE_3D2,IM_OUT,(JM_OUT+1),GEOLON_S, GEOLAT_S,KGDSI)
 ...
 END SUBROUTINE WRITE_FV3_ATMS_NETCDF_GRBSRC
...
SUBROUTINE READ_NAM_SFC_HEADER_NEMSIO (IMI,JMI,IVSI,LSOILI, &
...
! check bad status
 print *, 'GET KGDS_INPUT FROM NAM DATA'
 CALL NEMSIO_GETHEADVAR(GFILEISFC,'KGDS',KGDS_INPUT,IRET=IRET)
 ...
 END SUBROUTINE READ_NAM_SFC_HEADER_NEMSIO
...
! check bad status
 ...
 SUBROUTINE READ_GRBGFS_SFC_DATA_NEMSIO (IMI, JMI, LSOILI, SFCINPUT, &
 ...
 REAL, INTENT(OUT)    :: T2MI(IMI,JMI)
 REAL, INTENT(OUT)    :: Q2MI(IMI,JMI)
 REAL, INTENT(OUT)	  :: F10MI(IMI,JMI)
 ...
 print *, 'READ SNOD'
 CALL NEMSIO_READRECV(GFILEISFC, 'snwdph', 'sfc', 1, TMP, IRET=IRET)
 IF (IRET /= 0) GOTO 99
 SFCINPUT%SNOW_DEPTH = RESHAPE(TMP, (/IMI,JMI/) )
 SFCINPUT%SNOW_DEPTH = SFCINPUT%SNOW_DEPTH * 1000.0 ! convert to mm
...
! SFCINPUT%SOILM_LIQ(:,:,4) = RESHAPE(TMP, (/IMI,JMI/) )
 ...
 END SUBROUTINE READ_GRBGFS_SFC_DATA_NEMSIO
 
 SUBROUTINE READ_GRBRAP_SFC_DATA_NEMSIO (IMI, JMI, LSOILI, SFCINPUT, &
                                 T2MI, Q2MI, UUSTARI,SRFLAGI)
 ...
 REAL, INTENT(OUT)    :: T2MI(IMI,JMI)
 REAL, INTENT(OUT)    :: Q2MI(IMI,JMI)
 REAL, INTENT(OUT)    :: UUSTARI(IMI,JMI)
 ...
 print *, 'READ SOILW4'
 CALL NEMSIO_READRECV(GFILEISFC, 'soilw', '100-300 cm down', 1, TMP, IRET=IRET)
 IF (IRET /= 0) GOTO 99
 SFCINPUT%SOILM_TOT(:,:,4) = RESHAPE(TMP, (/IMI,JMI/) )
...
! SFCINPUT%SOILM_LIQ(:,:,4) = RESHAPE(TMP, (/IMI,JMI/) )
 ...
 print *, 'READ SOILT4'
 CALL NEMSIO_READRECV(GFILEISFC, 'tmp', '100-300 cm down', 1, TMP, IRET=IRET)
 IF (IRET /= 0) GOTO 99
 SFCINPUT%SOIL_TEMP(:,:,4) = RESHAPE(TMP, (/IMI,JMI/) )
 ...
 END SUBROUTINE READ_GRBRAP_SFC_DATA_NEMSIO
...
print *, 'parallel do assign data to SFCINPUT'

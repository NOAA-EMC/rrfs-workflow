...
# rrfs-workflow.20260512.dev-sci
EXPT_SUBDIR="det_c13_3dvar_jedi_baseline003"
...
ARCHIVEDIR="/NCEPDEV/emc-meso/5year/Donald.E.Lippi/RRFSv1/May2024_retro/$version/$EXPT_SUBDIR/"

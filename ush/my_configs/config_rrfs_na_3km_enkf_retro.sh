...
NWGES="/lfs/h2/emc/ptmp/$USER/July2025_retro/$EXPT_SUBDIR/${version}/nwges"
if [[ ${DO_ENSFCST} == "TRUE" ]] ; then
  STMP="/lfs/h2/emc/stmp/$USER/July2025_retro/$EXPT_SUBDIR/$version/ensfcst"
  PTMP="/lfs/h2/emc/ptmp/$USER/July2025_retro/$EXPT_SUBDIR/$version/ensfcst"
  NWGES="$NWGES"
fi
ENSCTRL_STMP="$STMP"
ENSCTRL_PTMP="$PTMP"

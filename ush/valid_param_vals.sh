...
valid_vals_EXTRN_MDL_NAME_LBCS=("GFS" "GEFS" "RRFS")
...
valid_vals_GFS_FILE_FMT_ICS=("grib2" "netcdf")
valid_vals_GFS_FILE_FMT_LBCS=("grib2" "netcdf")
...
valid_vals_RUN_TASK_PRDGEN=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
...
valid_vals_DO_ANALYSIS_NONVARCLD=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")

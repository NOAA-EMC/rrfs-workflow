...
valid_vals_DO_DACYCLE=("TRUE" "FALSE")
valid_vals_DO_SURFACE_CYCLE=("TRUE" "FALSE")
valid_vals_DO_RETRO=("TRUE" "FALSE")
valid_vals_DO_SPINUP=("TRUE" "FALSE")
valid_vals_LBCS_ICS_ONLY=("TRUE" "FALSE")
valid_vals_DO_NONVAR_CLDANAL=("TRUE" "FALSE")
valid_vals_DO_REFL2TTEN=("TRUE" "FALSE")

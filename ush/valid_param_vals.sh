...
valid_vals_MACHINE=("WCOSS2" "HERA" "ORION" "JET" "HERCULES" "GAEA" "URSA")
...
valid_vals_DO_PARALLEL_DA=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
...
valid_vals_DO_DUPLICATE_TAGGING=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")
valid_vals_EXT_SONDE=("TRUE" "true" "YES" "yes" "FALSE" "false" "NO" "no")

...
def smart_save4next_groups(dcCycleDef):
    ...
    fcst_lengths = '72 03 03 12 03 03 12 03 03 12 03 03 72 03 03 12 03 03 12 03 03 12 03 03'  # debug
    ...
    save_timelevels = {int(x): int(x) for x in mpasout_timelevels.split() if x != '0'}
    ...
    #
    # check each save_timelevels to determine what key index in cycles_by_fcst_length_sorted it belongs to
    ...
    for index, item in enumerate(save_timelevels):
        ...
        dcTmp = {"fhr": f'{item}', "cycledef": f'{mycycledef}'}

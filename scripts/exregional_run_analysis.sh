...
#else                          # cycling
#  cp ${analworkdir}/fv3_dynvars             ${bkpath}/fv_core.res.tile1.nc
#  cp ${analworkdir}/fv3_tracer              ${bkpath}/fv_tracer.res.tile1.nc
#  cp ${analworkdir}/fv3_sfcdata             ${bkpath}/sfc_data.nc
#fi

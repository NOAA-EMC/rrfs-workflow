...
####    if [ -r ${COMIN_HRRR}/nwges/hrrrges_sfc/alaska/hrrrak_${new_cdate}f001 ]; then
####      # hrrrak_2025040209f008 every 3 hours (04z or 16z) or (07z or 19z)
####      ln -s ${COMIN_HRRR}/nwges/hrrrges_sfc/alaska/hrrrak_${new_cdate}f001 sfc_hrrrak

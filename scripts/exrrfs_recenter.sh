...
export ctrlpath=${COMrrfs}/rrfs.${PDY}
...
#-----------------------------------------------------------------------
#
dynvarfile_control=${ctrlpath}/${cyc}/forecast/INPUT/fv_core.res.tile1.nc
tracerfile_control=${ctrlpath}/${cyc}/forecast/INPUT/fv_tracer.res.tile1.nc
dynvarfile_control_spinup=${ctrlpath}/${cyc}_spinup/forecast/INPUT/fv_core.res.tile1.nc
tracerfile_control_spinup=${ctrlpath}/${cyc}_spinup/forecast/INPUT/fv_tracer.res.tile1.nc
